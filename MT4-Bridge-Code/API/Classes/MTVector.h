...
public:
   explicit          TMTVector(const bool size_fixed=false) : m_size_fixed(size_fixed) {}
                    ~TMTVector(void) {}
   //--- clear
   void              Clear(void);
   //--- initialization
   ...
   template<class Func>
   bool              Operation(const TMTVector &r,const Func &func);
  };
//+------------------------------------------------------------------+
//| clear                                                            |
//+------------------------------------------------------------------+
template<class T>
void TMTVector<T>::Clear(void)
  {
   m_items.Clear();
  }
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
template<class T>
bool TMTVector<T>::Initialize(const UINT size)
  {
//--- clear
   Clear();
//--- check empty size
...
//+------------------------------------------------------------------+
template<class T>
T* TMTVector<T>::Item(const UINT pos)
  {
//--- check existing item
...
template<class T>
template<class Func>
bool TMTVector<T>::Operation(const TMTVector &r,const Func &func)
  {
